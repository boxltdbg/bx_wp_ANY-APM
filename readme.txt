=== BOX NOW Bulgaria ===
Contributors: boxnowbulgaria, dragoivanov
...
= 2.1.5 =
* Added functionality to exclude multiple shipping classes for our delivery method.
* Added functionality to toggle on/off to show the WooCommerce order number into the label.
